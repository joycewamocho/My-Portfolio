...
export default function About() {
  ...
  // Load SweetAlert2 script on the client side
  useEffect(() => {
  ...
  const handleDownload = async (e) => {
    ...
    try {
      ...
      const cvUrl = "https://www.dropbox.com/scl/fi/q7tqqccw72u4nxj0wqlop/CURRICULUM-VITAE-Joyce-Wamocho.pdf?rlkey=0rk885dazep389pgikz92h92q&st=dma401ne&dl=1";
      console.log("Initiating download from:", cvUrl);

      const link = document.createElement("a");
      link.href = cvUrl;
      link.download = "Joyce_Wamocho_CV.pdf";
